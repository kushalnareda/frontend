...
type NavbarProps = {
  onGroupChange: (groupBy: 'status' | 'user' | 'priority') => void; // More specific type
  onSortChange: (sortBy: 'priority' | 'title') => void;   // Callback to handle sorting
};

const Navbar: React.FC<NavbarProps> = ({ onGroupChange, onSortChange }) => {
      ...
      {isDropdownVisible && (
        <div className="dropdown-menu">
          <div className="dropdown-section">
            ...
            <select onChange={(e) => onGroupChange(e.target.value as 'status' | 'user' | 'priority')}>
